...
class DMPDatasetEERandTarXYLang(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print(joint_angles_traj)
        return img, sentence, detailed_sentence # phis, mask, sentence, joint_angles_traj, joints_angles, ee_pos, tar_pos, displacement
...
def pad_collate_xy_lang(batch):
    ...
    detailed_sentence = torch.stack(detailed_sentence)
